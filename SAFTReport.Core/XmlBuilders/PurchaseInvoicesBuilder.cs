...
{
    public class PurchaseInvoicesBuilder : IPurchaseInvoicesBuilder
    {
        private readonly SAFTDbContext dbContext;
        private readonly DateUtility utility;

        public PurchaseInvoicesBuilder(SAFTDbContext context, DateUtility dateUtility)
        {
            dbContext = context;
            utility = dateUtility;
        }
        public XElement BuildSection(int month, int year)
        {
            ...
            var customers = dbContext.Suppliers
            ...
            XElement salesInvoicesElement = new XElement("PurchaseInvoices",
            ...
            foreach (var item in salesInvoices.Values)
            {
                ...
                var customerInfo = customers.Values.FirstOrDefault(c => c.AccountId == firstItem.SupplierId);
